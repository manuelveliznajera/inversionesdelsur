...
class Loans extends Component
{
    ...
    public function Save()
    {
        ...
        try {
            ...
            if ($this->frecuency_id==1) {
            $this->plan=$this->PlanDiario($this->amount);
                
            }elseif ($this->frecuency_id==2) {
    ...
    {
        if ($this->method == 'Diario') {
                 $this->plan = $this->PlanDiario($this->rate, $this->amount);
